...
SECRET_KEY = 'fa2cg_oibgx9byov#19_^nhi@8x#b=p+%-58=@ge!4wr+ut3ia'
...
TEMPLATES = [
    {
        ...
        "DIRS": ['/app/templates', os.path.join(BASE_DIR, 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Database - sorry - just a simple file for this one..
DATABASES = {
    'default': {
